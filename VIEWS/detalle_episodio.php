...
<body>
    ...
    <div class="container">
        <div class="card mb-3">
            <div class="row g-0 " style="height: 213px;">
                <div class="col-md-4">
                    <?php echo '<img src="' . $link . '" class="img-fluid rounded-start" style="height: 203px; margin: 2%; border-radius: 20px">'; ?>
                </div>
                <input type="hidden" value="<?php echo $url ?>" name="url">
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title"><?php echo "Episodio" . " " . $api['id'],  ": " . $api['name'] ?></h5>
                        <p class="card-text"><?php echo $tex ?> </p>
                        <p class="card-text"><small class="text-muted"><?php echo '<strong>- Fecha de lanzamiento: </strong>' . $api['air_date']  ?></small></p>
    ...
    <div class="container">
        ...
        foreach ($api['characters'] as $value1) {
            ...
            $personaje = json_decode($response, true);


        ?>


            <form action="./detalle-personaje.php" method="POST" style="width: 540px;">
                <div class="card mb-3">
                    <div class="row g-0 " style="height: 285px;">
                        <div class="col-md-4">
                            <?php echo '<img src="' . $personaje['image'] . '" class="img-fluid rounded-start" style="height: 275px; margin: 2%; border-radius: 20px">'; ?>
                        </div>
                        <input type="hidden" value="<?php echo $personaje['url'] ?>" name="url">
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo "Personaje" . " " . $personaje['id'],  ": " . $personaje['name'] ?></h5>

                                <p class="card-text"><?php echo '<strong>- Status: </strong>' . $personaje['status'] ?> </p>
                                <p class="card-text"><?php echo '<strong>- Species: </strong>' . $personaje['species'] ?> </p>
                                <p class="card-text"><?php echo '<strong>- Origin: </strong>' . $personaje['origin']['name'] ?> </p>
                                <p class="card-text"><?php echo '<strong>- Gender: </strong>' . $personaje['gender'] ?> </p>
